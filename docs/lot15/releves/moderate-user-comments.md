...
| R5 | n1 : commentaire d'espaces à 0 | démontrée en Python (trois espaces, « \n\t », espace de largeur nulle : 0) ; **DÉFAUT en JavaScript** : 0,7104, signalé | test_production_un_commentaire_d_espaces_n_est_pas_signale_et_vaut_zero / DÉFAUT : un commentaire d'espaces… |
